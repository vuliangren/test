...
public class DruidConfiguration {
    ...
    public ServletRegistrationBean druidServlet() {
        ...
        // 登录账户
        initParameters.put("loginUsername", ServiceConst.get(applicationName).getServiceName());
        // 登录密码
        initParameters.put("loginPassword", "welearn");
    ...
    public DruidDataSource druidDataSource() throws SQLException {
        ...
        connectProperties.setProperty("druid.stat.slowSqlMillis","500");
        datasource.setConnectProperties(connectProperties);
        datasource.setFilters(filters);
        List<Filter> proxyFilters = new ArrayList<>();
        proxyFilters.add(this.getSlf4jLogFilter());
    ...
    public Slf4jLogFilter getSlf4jLogFilter(){
        ...
        filter.setStatementExecutableSqlLogEnable(isInDebugModel);
        return filter;
    }
}
