...
@RestController
@Validated
@RequestMapping(value = "/equipmentAccessory")
public class EquipmentAccessoryController extends BaseController<EquipmentAccessory, EquipmentAccessoryQueryCondition, EquipmentAccessoryService>{
