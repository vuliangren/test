...
public interface HighPricePartProcurementApplicationFeignClient {

    @RequestMapping(value = "/highPricePartProcurement/apply")
    CommonResponse<ApprovalApplication> apply(Apply<RepairReplacement> entity);

    @RequestMapping(value = "/highPricePartProcurement/cancel")
