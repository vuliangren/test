...
public interface SparePartStockInApplyFeignClient {

    @RequestMapping(value = "/sparePartStockInApply/apply")
    CommonResponse<ApprovalApplication> apply(Apply<SparePartInBill> entity);
}