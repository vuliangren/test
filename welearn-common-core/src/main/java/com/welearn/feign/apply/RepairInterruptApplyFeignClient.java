...
/**
 * Description : welearn-apply-service / com.welearn.controller.RepairInterruptApplyController
...
public interface RepairInterruptApplyFeignClient {

    @RequestMapping(value = "/repairInterruptApply/apply")
    CommonResponse<ApprovalApplication> apply(Apply<RepairInterrupt> entity);
}