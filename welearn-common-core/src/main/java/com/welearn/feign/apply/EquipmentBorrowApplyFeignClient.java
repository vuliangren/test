...
public interface EquipmentBorrowApplyFeignClient {

    @RequestMapping(value = "/equipmentBorrowApply/apply")
    CommonResponse<ApprovalApplication> apply(Apply<EquipmentBorrow> entity);
}