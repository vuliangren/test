...
/**
 * Description : welearn-apply-service / com.welearn.controller.RepairHelpQuotationApprovalController
...
public interface RepairHelpQuotationApprovalFeignClient {
    ...
    @RequestMapping(value = "/repairHelpQuotationApproval/apply")
    CommonResponse<ApprovalApplication> apply(Apply<RepairHelpQuotationApproval> entity);
}