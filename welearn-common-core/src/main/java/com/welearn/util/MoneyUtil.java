...
/**
 * Description :
 * Created by https://www.cnblogs.com/EN-Dean/p/7943567.html on 2019/3/1.
 */
public class MoneyUtil {
    ...
    public static String toChinese(Double numberOfMoney){
        return toChinese(new BigDecimal(numberOfMoney));
    }
