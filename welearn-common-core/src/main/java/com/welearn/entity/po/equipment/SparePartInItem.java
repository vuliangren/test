...
/**
 * Persistent Object : ryme_equipment : spare_part_in_item
...
@ApiModel(value = "SparePartInItem", description = "SparePartInItem 领域实体")
public class SparePartInItem extends BasePersistant
{
    /**
    ...
    /**
     * Description  : 状态:0-申请中 1-待入库 2-待确认 2-已入库 3-已取消
     * Constraint   : [NOT NULL] 
     * TableColumn   : [ryme_equipment:int][PRECISION:10]
     * DefaultValue : 0
     */
    @ApiModelProperty( value = "状态:0-申请中 1-待入库 2-待确认 2-已入库 3-已取消", allowEmptyValue = true, position = 12 )
     ...
     * TableColumn   : [ryme_equipment:varchar][SIZE:32]
     */
    @ApiModelProperty( value = "入库单id", allowEmptyValue = true, position = 13 )
    private String sparePartInBillId;
     ...
     * TableColumn   : [ryme_equipment:varchar][SIZE:32]
     */
    @ApiModelProperty( value = "维修配件更换id", allowEmptyValue = true, position = 14 )
     ...
     * TableColumn   : [ryme_equipment:varchar][SIZE:32]
     */
    @ApiModelProperty( value = "采购详情id", allowEmptyValue = true, position = 16 )
    ...
    /**
     * Description  : 入库后的批次id
     * Constraint   : [CAN NULL]
     * TableColumn   : [ryme_equipment:varchar][SIZE:32]
     */
    @ApiModelProperty( value = "入库后的批次id", allowEmptyValue = true, position = 19 )
